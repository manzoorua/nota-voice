-- Create voice_notes table for storing voice recordings and transcripts
...
CREATE INDEX idx_voice_notes_user_id_created_at ON public.voice_notes(user_id, created_at DESC);
